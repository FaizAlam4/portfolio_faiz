    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="education-item">
          ...
          <p>Kendriya Vidyalaya No. 1, <strong>Percentage: 91.6%</strong> [2017] </p>
        </div>
        <br />
        <div className="education-item">
          <h2>Certificates/Certifications <a id='lk' href="https://drive.google.com/drive/folders/1lepuDQLsZsN3qQQ6tm1knUtB7fWtzdCc?usp=sharing" target={"_blank"}>link</a></h2>
